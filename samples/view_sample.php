...
<body>
    ...
    <div class="w3-container">
        ...
        print  $row['testName'];
        print  '<br><span style="font-weight: bold">Sample Type:  </span>  ';
        print  $row['testType'];
    ...
    <div class="w3-bar w3-center w3-black"><a href="samples.php" class="w3-button" style="background-color:#9b1d20; color:goldenrod;"><< BACK</a></div>
    <br /><br /><br />
    </div>
