...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-mobile w3-bar"><a href="dashboard.php" class="btn btn-secondary" style="background-color: #df1c08; color: #000000;">DASHBOARD</a><input type="text" placeholder="search" id="searchBar" onkeyup="tableFilter()" class="w3-right"></div>
    ...
    <div id="myModal2" class="modal">
        <div class="modal-content">
          ...
          <br />
          <input class="btn" type="submit" value="View" style="background-color:#9b1d20; color:#df1c08;">
          </form>
        </div>
    </div> -->
