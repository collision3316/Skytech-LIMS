...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-mobile w3-bar"><a href="../dashboard.php" class="btn btn-secondary" style="background-color: #df1c08; color: #000000;">DASHBOARD</a><a href="addperson.html" class="btn btn-secondary" style="background-color: #000000; color: #df1c08;">ADD</a><button class="btn btn-secondary" style="background-color: #000000; color: #df1c08;" id="view-sample">VIEW</button><button class="btn btn-danger" id="delete-sample">DELETE</button><input type="text" placeholder="search" id="searchBar" onkeyup="tableFilter()" class="w3-right"></div>
    
      <!-- Delete Person -->
      <div id="myModal" class="modal">
          <div class="modal-content">
            <span class="close w3-right" style="font-size: 2em; color: green">&times;</span>
            <span class="w3-bar" style="background-color:red; color:white;">DELETE PERSON FROM DATABASE</span>
    ...
    <div id="myModal2" class="modal">
        <div class="modal-content">
          ...
          <span class="w3-bar" style="background-color:#df1c08; color:#000000;">VIEW FULL PERSON DETAILS</span>
          <form method="POST" action="view_person.php">
          <br />
          <p><input type="text" placeHolder="Entry No" name="sampleId"></p>
          <br />
          <input class="btn" type="submit" value="View" style="background-color:#000000; color:#df1c08;">
          </form>
        </div>
    </div>
        ...
        <tr>
            <?php  
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    print '<tr><td>'. $row['id']. '</td><td>'. $row['position'].'</td><td>'. $row['fname']. '</td><td>'. $row['lname'].'</td><td>'. $row['email']. '</td><td>'. $row['cell'].'</td><td>'.$row['addresss'].'</td>';
                }
            ?>
    </table>
