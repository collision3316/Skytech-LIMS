...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-mobile w3-bar"><a href="../dashboard.php" class="btn btn-secondary" style="background-color: #df1c08; color: #000000;">DASHBOARD</a><a href="pulp-rock-picker.html" class="btn btn-secondary" style="background-color: #000000; color: #df1c08;">ADD</a><a href="edit_results.html" class="btn btn-secondary" style="background-color: #000000; color: #df1c08;">RESULT</a><button class="btn btn-danger" id="delete-sample">DELETE</button><input type="text" placeholder="search" id="searchBar" onkeyup="tableFilter()" class="w3-right"></div>
