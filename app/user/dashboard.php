...
<body>
    ...
    <div class="w3-center">
        <div class="row">
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white">
                    <div class="card-header" style="background-color:#df1c08">SAMPLES</div>
                    <div class="card-body">
                        Sample tracking
                    </div>
            ...
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white">
                    <div class="card-header" style="background-color:#df1c08">WORKFLOW</div>
                    <div class="card-body">
                        Protocol Execution
                    </div>
            ...
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:#ffffff" style="width:400px">
                    <div class="card-header" style="background-color:#df1c08">INVENTORY</div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white" style="width:400px">
            ...
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white">
                    <div class="card-header" style="background-color:#df1c08">PERSONNEL</div>
                    <div class="card-body">
    ...
    <br><br>
    <div class="w3-bar" style="background-color:#000000; color:white"><a href="reset-password.php" class="w3-button" style="background-color:#df1c08; color:white">Reset Password</a></div>
