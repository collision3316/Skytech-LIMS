...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-bar">
    <a href="../dashboard.php" class="w3-button" style="background-color:#df1c08;color:#000000;font-weight:bold;">DASHBOARD</a><h1>Protocols & Procedures</h1>
    </div>
    <ul id="headlines">
...
<?php } ?>
      ...
      <p class="w3-button" style="background-color:#df1c08;color:#000000;"><a href="./?action=archive">View More</a></p>
