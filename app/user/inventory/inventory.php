...
<body>
    ...
    <div id="myModal2" class="modal">
        <div class="modal-content">
          ...
          <span class="w3-bar" style="background-color:#000000; color:white;">VIEW FULL ITEM DETAILS</span>
        ...
        <tr>
            <?php  
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    print '<tr><td>'. $row['id']. '</td><td>'. $row['itemName'].'</td><td>'. $row['quantity']. '</td><td>'. $row['itemCode'].'</td>';
                }
            ?>
    </table>
