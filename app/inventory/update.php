...
<body>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white">
                    <div class="card-header" style="background-color:#df1c08">TAKE FROM STOCK</div>
                    <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card" style="background-color:#000000; color:white">
                    <div class="card-header" style="background-color:#df1c08">ADD TO STOCK</div>
                    <div class="card-body">
    ...
    <br><br>
    <a href="inventory.php" class="btn" style="background-color:#000000; color:#df1c08"><h1>BACK</h1></a>
