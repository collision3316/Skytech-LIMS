...
<body>
    ...
    <?php
        try{
            ...
            $stmt = $conn->prepare("INSERT INTO stock (itemName, itemCode, quantity) VALUES(:itemName, :itemCode, :quantity)");
        ...
        catch(PDOException $skytech){
            echo '<h1 style="font-size:70px" class="w3-bar w3-red w3-text-bold">Error: ' . $skytech->getMessage() . '</h1>';
        }

        $conn = null;

?>
    <a href="inventory.php" class="w3-bar w3-center" style="background-color:#9b1d20;color:goldenrod;"><h1>BACK</h1></a>
