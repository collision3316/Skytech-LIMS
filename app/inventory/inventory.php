...
<body>
    ...
    <div id="myModal2" class="modal">
        <div class="modal-content">
          ...
          <span class="w3-bar" style="background-color:#000000; color:#df1c08;">VIEW FULL ITEM DETAILS</span>
