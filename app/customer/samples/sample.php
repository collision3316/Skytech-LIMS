...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-mobile w3-bar"><a href="../../logout.php" class="w3-button" style="background-color:#df1c08; color:#000000; text-decoration:none;">LOGOUT</a><input type="text" placeholder="search" id="searchBar" onkeyup="tableFilter()" class="w3-right"></div>
