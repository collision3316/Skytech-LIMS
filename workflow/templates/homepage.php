...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-bar">
    <a href="../dashboard.php" class="w3-button" style="background-color:#9b1d20;color:goldenrod;font-weight:bold;">DASHBOARD</a><a href="admin.php" class="w3-button" style="background-color:#9b1d20;color:goldenrod;font-weight:bold;">ADD</a><h1>Protocols & Procedures</h1>
    </div>
    <ul id="headlines">
