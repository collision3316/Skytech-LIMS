...
<br><br><br><br>
    <div class="w3-container w3-center">
        <?php 
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="width:40%">
                ...
                <br />
                <div class="form-group">
                    <input type="submit" class="w3-button" value="Login" style="background-color:#9b1d20; color: goldenrod;">
                </div>
            </form>
        </div>
