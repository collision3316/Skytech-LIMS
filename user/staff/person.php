...
<body>
    ...
    <br><br><br><br><br>
    <div class="w3-mobile w3-bar"><a href="../dashboard.php" class="btn btn-secondary" style="background-color: #9b1d20; color: goldenrod;">DASHBOARD</a><button class="btn btn-secondary" style="background-color: #9b1d20; color: goldenrod;" id="view-sample">VIEW</button><input type="text" placeholder="search" id="searchBar" onkeyup="tableFilter()" class="w3-right"></div>
    ...
    <div id="myModal2" class="modal">
        <div class="modal-content">
          ...
          <span class="w3-bar" style="background-color:#9b1d20; color:white;">VIEW FULL PERSON DETAILS</span>
