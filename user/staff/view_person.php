...
<body>
    ...
    <div class="w3-center">
        ...
        print  $row['lname'];
        print  '<br><span class="w3-bar" style="font-weight: bold">ROLE:</span><br>';
        print  $row['position'];
    ...
    <div class="w3-bar w3-center w3-black"><a href="person.php" class="w3-button" style="background-color:#9b1d20; color:goldenrod;"><< BACK</a></div>
    <br /><br /><br />
    </div>
